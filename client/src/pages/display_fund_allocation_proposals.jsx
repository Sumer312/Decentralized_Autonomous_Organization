...
import fundallocation from "../../../web3/artifacts/contracts/FundAllocation.sol/FundAllocation.json"
...
const DisplayFundAllocationProposal = () => {
  ...
  return (
    <div class="flex flex-col gap-6 p-24">
      ...
      <p class="text-2xl text-accent font-mono font-semibold">{proposal() && proposal().concernedDepartment} </p>
      <p class="text-2xl text-accent font-mono font-semibold">{proposal() && proposal().recepient} </p>
